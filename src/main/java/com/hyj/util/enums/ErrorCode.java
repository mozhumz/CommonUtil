...
//    LOGIN_EXCEPTION(40001, "登录失效，请重新登录", "com.hyj.util.exception.BaseException"),
    /**
     * com.xdbigdata.framework.common.exception.BaseException
     */
    INTERNAL_PROGRAM_ERROR(50000, "程序内部错误，操作失败", "com.hyj.util.exception.BaseException"),
    /**
